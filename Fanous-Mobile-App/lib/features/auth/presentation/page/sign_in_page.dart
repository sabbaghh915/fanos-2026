...
import 'package:fanous/features/auth/presentation/page/sign_up_page.dart';
...
class SignInPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      resizeToAvoidBottomInset: true, // مهم للكيبورد
      body: SafeArea(
        child: Column(
          spacing: 10.h,
          children: [
            ...
            /// ===== Bottom Container (fills remaining space) =====
            Expanded(
              child: Container(
                width: double.infinity,
