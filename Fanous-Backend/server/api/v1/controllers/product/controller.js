...
export class productController {
  ...
  async viewProduct(req, res, next) {
    ...
    try {
      ...
      // Fix: Check if productId is valid (not "undefined" string or empty)
      if (!validatedBody.productId || validatedBody.productId === "undefined" || validatedBody.productId === "") {
        throw apiError.badRequest(responseMessage.PRODUCT_NOT_FOUND);
      }
      
      // Validate ObjectId format
      if (!mongoose.Types.ObjectId.isValid(validatedBody.productId)) {
        throw apiError.badRequest(responseMessage.PRODUCT_NOT_FOUND);
      }
      ...
      if (
        ...
        mongoose.Types.ObjectId.isValid(validatedBody.userId)
      ) {
