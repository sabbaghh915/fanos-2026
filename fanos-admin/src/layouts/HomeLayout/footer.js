...
const useStyles = makeStyles((theme) => ({
  ...
  footerSection: {
    background: "linear-gradient(180deg, #003847 0%, #0D6976 100%)",
    padding: "35px",
  },
            ...
            <Box className={classes.logoBox}>
              ...
              <Box pt={1}>
                ...
                <Box className={classes.iconsContainer}>
                  ...
                  <a href="https://twitter.com/fanos6506" target="_blank">
                    <img alt="img" src={"images/twitter_logo.png"} />
                  </a>
                  <a href="https://www.instagram.com/fanos6506/" target="_blank">
                    <img alt="img" src={"images/instagram_logo.png"} />
                  </a>
                </Box>

                <Box className={classes.googlePlayContainer}>
                  <a href="https://play.google.com" target="_blank">  <img alt="img" src={"images/googlePlay.svg"} /></a>
                  <a href="https://www.apple.com" target="_blank">  <img alt="img" src={"images/applestore.svg"} /></a>
