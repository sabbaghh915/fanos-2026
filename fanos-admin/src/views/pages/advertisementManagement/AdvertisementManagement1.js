    ...
    return (
      <Grid container style={{ alignItems: "center",display:"flex",flexWrap:"nowrap" }}>
        <Grid item md={6} xs={12}>
          ...
          <Link
            to={{
              pathname: "/edit-advertisement-type1",
              state,
              img,
            }}
          >
      ...
      <Box className={classes.bannerbox}>
        <Box className={classes.mainbox}>
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <Typography variant="h4">Advertisement Management - Type 1</Typography>
            </Grid>
            <Grid item xs={6} align="end">
              <Link to="/add-advertisement-management-type1">
