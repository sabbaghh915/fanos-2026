...
const AddAdvertisementType2 = () => {
    ...
    const handleBack = () => {
        history.push("/advertisement-management-type2");
    };
    ...
    const handleFormSubmit = async () => {
        ...
        try {
            if (!profileImage64) {
                ...
                formData.append("advertisementType", "TYPE_2");
            ...
            <Box className={classes.bannerbox}>
                <Box className={classes.mainbox}>
                    <Grid container className="d-flex justify-space-between">
                        <Typography variant="h4">Add Advertisement - Type 2</Typography>
                    </Grid>
...
export default AddAdvertisementType2;
