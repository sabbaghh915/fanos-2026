...
const Product = function (props) {
  ...
  const sellersProfile = async () => {
    // احصل على productId من URL أو من state
    const finalProductId = userId || productId;
            ...
            <Grid item xs={12} sm={12} md={6} className={classes.secondGridItem}>
              ...
              <div className={classes.divMap}>
                <div className={classes.divMapFirst}>
                  {dataProfile ? (
                    <img alt="Profile" src={!dataProfile || dataProfile === "undefined" || dataProfile === undefined ? "images/profile.svg" : dataProfile} style={{
                      borderRadius: "50%", width: "50px", height: "50px",
                    }} />
                  ) : (
                    <img alt="Profile" src="images/profile.svg" style={{
                ...
                <div className={classes.divMapSecond}>
                  {localStorage.getItem("token") ? (
                    ...
                    >
                      ...
                      <MdArrowForwardIos style={{ color: "#6D28D9" }} />
                    </div>
                  ) : (
                    <>
                      <Typography variant="body1" className={classes.viewProfile}>
                      ...
                      <MdArrowForwardIos style={{ color: "#6D28D9" }} onClick={() => handleLogoutProfile()}
                      />
                    </>
                  )}
                </div>
