...
const BestPriceProduct = function () {
  ...
  try {
    ...
    if (res.data.status === true && res.data.data) {
      ...
      console.log("Best price product frontend:", res.data.data);
  ...
  <Box className={classes.viewMoreBox}>
    <Typography className={classes.search}>Best Price Products</Typography>
  </Box>
)}
